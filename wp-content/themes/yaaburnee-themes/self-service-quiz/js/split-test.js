function enp_splitTest(quiz1, quiz2) {
    ...
    iframeContainer.innerHTML = '<iframe frameBorder="0" height="'+quizzes[rand].height+'" width="'+quizzes[rand].width+'" src="http://dev/enp/iframe-quiz/?guid='+quizzes[rand].guid+'"></iframe>';
}
