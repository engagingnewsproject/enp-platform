...
<div class="innercontent">
	<div class="container">
        ...
        <?php /* Removed Featured Research section at Katie's request -- JJ
        <h2 class="maintitle">Featured <span>Research</span></h2>
            query_posts( array( 'post_type'=> 'page', 'post_parent' => '582') ); if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
