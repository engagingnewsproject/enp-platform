...
<div class="socialmedia"><a href="<?php bloginfo('rss_url'); ?>" class="icon3"></a><a href="<?php the_field('facebook',412); ?>" class="icon1"> </a><a href= "<?php the_field('twitter',412); ?>" class="icon2"></a></div>
                <div class="inner">
...
<div class="calltoaction"><div class="container"><?php the_field('main_description',412); ?></div></div>
<?php } else { ?> 
<?php } ?>