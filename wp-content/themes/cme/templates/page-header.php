...
<!-- <div class="page-header <?php //if ( has_post_thumbnail() ) { ?> hero-bg <?php //} ?>" style="clear: both; <?php //if ( has_post_thumbnail() ) { ?> background-image: linear-gradient(rgba(238, 238, 238, 0.26), rgba(29, 29, 29, 0.57)), url('<?php //echo $hero['0'];?><?php //} ?>');"> -->
