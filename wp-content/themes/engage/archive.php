...
if(get_query_var('verticals') == 'media-ethics' && $_SERVER['REQUEST_URI'] == '/vertical/media-ethics/') {
  $context['navTiles'] = [
    [
      ...
      "imgAlt" => "Person typing on laptop computer",
    ...
    [
      ...
      "imgAlt" => "Advertisements on billboards in New York City",
    ...
    [
      ...
      "imgAlt" => "Phone with Google Search Engine pulled up",
    ...
    [
      ...
      "imgAlt" => "An artist holding their paintbrush above several containers of paint",
    ...
    [
      ...
      "imgAlt" => "Heart monitor showing healthy vital signs",
    ...
    [
      ...
      "imgAlt" => "Basketball sitting on empty basketball court",
    ...
    [
      ...
      "imgAlt" => "UT Center for Media Engagement logo",
