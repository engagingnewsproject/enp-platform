...
function toggleSemester(arg) {
	const class_name_1 = "past-interns-title-" + arg;
	const class_name_2 = "past-interns-list-" + arg;
...
function changeArrowDirection(arg) {
	const class_name = "past-interns-title-" + arg;
...
semesters.forEach(
	function(semester) {
		const class_name = "past-interns-title-" + semester;
