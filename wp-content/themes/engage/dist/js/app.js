...
function toggleSemester(arg) {
	var class_name_1 = "past-interns-title-" + arg;
	var class_name_2 = "past-interns-list-" + arg;
...
function changeArrowDirection(arg) {
	var class_name = "past-interns-title-" + arg;
...
semesters.forEach(function (semester) {
	var class_name = "past-interns-title-" + semester;
