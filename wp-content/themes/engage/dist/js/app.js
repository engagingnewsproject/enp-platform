...
/******/ 		return __webpack_require__.p + "dist/js/chunk/" + ({}[chunkId]||chunkId) + "." + {"0":"2e2b37e2d99842a41a8c","1":"de169845b958bb298cdc"}[chunkId] + ".js"
/******/ 	}
/******/
...
function addOrDestroyMenu() {
  ...
  var _loop = function _loop(item) {
    if (collapsibles[item].breakpoint.min < w && w < collapsibles[item].breakpoint.max && collapsibles[item].collapsible === null) {
      __webpack_require__.e(/*! import() */ 0).then(__webpack_require__.bind(null, /*! ./collapse */ "./assets/js/collapse.js")).then(function (Collapse) {
...
if (document.getElementById('orbit-balls')) {
  __webpack_require__.e(/*! import() */ 1).then(__webpack_require__.bind(null, /*! ./orbit */ "./assets/js/orbit.js")).then(function (Orbit) {
    new Orbit["default"]();
  });
}
/*
...
if (document.getElementById("copy-embed-code")) {
  document.getElementById("copy-embed-code").onclick = function (e) {
    ...
    var button = e.target;
    button.classList.add("active"); // After 1 second, we take away the active class to hide the text

    setTimeout(function () {
      button.classList.remove("active");
    }, 1000); // Call the function that actually copies the text to the keyboard
...
function copyEmbedCode() {
  ...
  var codeText = document.getElementById("embed-code"); // Manually select the code and copy it to keyboard

  codeText.select();
  document.execCommand("copy"); // Clear our selection after we copy it
...
__webpack_require__(/*! /Users/xiejianjian/Local Sites/mediaengagementorg/app/public/wp-content/themes/engage/assets/js/app.js */"./assets/js/app.js");
module.exports = __webpack_require__(/*! /Users/xiejianjian/Local Sites/mediaengagementorg/app/public/wp-content/themes/engage/assets/scss/app.scss */"./assets/scss/app.scss");
