...
<div id="main_content" class="clearfix">
    ...
    <span class="bootstrap"><hr></span>
      ...
      <p>Copy and paste this code into your target website.</p>
	    <div class="form-group"><textarea class="form-control" rows="5"><?php echo '<iframe height="450" width="475" frameborder="0" hspace="0" src="' . get_site_url() . '/iframe-poll/?guid=' . $_GET["guid"] . '"></iframe>' ?></textarea></div>
      <div class="clear"></div>
