				...
				<?php } ?>
						...
						<div class="et_pt_portfolio_item">
							<?php if ($et_ptemplate_showtitle) { ?>
								<h2 class="et_pt_portfolio_title">
<a href="<?php the_permalink(); ?>"><?php echo esc_html( $et_portfolio_title ); ?></a></h2>
							<?php } ?>
							<div class="et_pt_portfolio_entry<?php if ( $height == $et_portrait_height ) echo ' et_portrait_layout'; ?>">
								<div class="et_pt_portfolio_image<?php if ( '' != $et_videolink || '' != $et_custom_embed_video ) echo ' et_video'; ?>"><a href="<?php the_permalink(); ?>">
