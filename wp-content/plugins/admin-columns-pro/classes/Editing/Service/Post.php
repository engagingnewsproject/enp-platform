...
class Post implements Editing\Service, PaginatedOptions
{
    ...
    protected Editing\PaginatedOptionsFactory $options_factory;

    public function __construct(
        View\AjaxSelect $view,
        Storage $storage,
        ?Editing\PaginatedOptionsFactory $options_factory = null
    ) {
        $this->view = $view;
    ...
    private function get_stored_post_id(int $id): ?int
    {
