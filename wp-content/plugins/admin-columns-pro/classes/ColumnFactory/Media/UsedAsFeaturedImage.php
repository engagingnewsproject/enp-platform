...
use ACP\Search;
use ACP\Value\ExtendedValue\Media\PostsHavingFeaturedImage;
...
class UsedAsFeaturedImage extends ACP\Column\AdvancedColumnFactory
{
    ...
    {
        return __('Used as Featured Image', 'codepress-admin-columns');
    }
