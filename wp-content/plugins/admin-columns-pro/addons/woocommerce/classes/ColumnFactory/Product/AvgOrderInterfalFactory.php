...
class AvgOrderInterfalFactory extends ACP\Column\AdvancedColumnFactory
{
    ...
    {
        return __('Average number of days between orders containing this product.', 'codepress-admin-columns');
    }
    ...
    protected function get_formatters(Config $config): FormatterCollection
    {
        return parent::get_formatters($config)
            ...
            ->add(new \AC\Formatter\HumanTimeDifference())
        ;
    }
    ...
    {
        return new Sorting\Product\Order\AvgOrderInterval($this->get_period_in_days($config));
    }
