...
class OrderTotal extends Comparison
{
    ...
    protected function create_query_bindings(string $operator, Value $value): Bindings
    {
        ...
        $join_alias = $bindings->get_unique_alias('product_revenue');
        ...
        $sub_query = "
            SELECT {$alias}.product_id, SUM({$alias}.product_net_revenue) AS total_revenue
        ...
        $comparison = ComparisonFactory::create("{$join_alias}.total_revenue", $operator, $value);
