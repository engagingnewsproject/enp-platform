 ...
 * @var int    $total
 * @var string $image
 * @var array  $posts       Each: ['id', 'post_type', 'post_title', 'post_status', 'post_date', 'acf_fields' => string[]]
            ...
            <tr>
                ...
                <td class="col-title">
                    ...
                    <?php if ( ! empty($post['acf_fields'])) : ?>
                        <span class="col-acf-fields">
                            <?php foreach ($post['acf_fields'] as $field_name) : ?>
                                <code class="acf-field-name"><?= esc_html($field_name) ?></code>
                            <?php endforeach; ?>
                        </span>
                    <?php endif; ?>
                </td>
