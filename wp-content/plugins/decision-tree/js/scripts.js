...
TreeView.prototype = {
    ...
    */
    ...
    addGroupStyles: function addGroupStyles() {
        ...
        for (var i = 0; i < groups.length; i++) {
            this.addStylesheetRule('.cme-tree__state--overview #' + groups[i].id + ', .cme-tree__state--overview #' + groups[i].id, [['transform', 'translate3d(' + groupsOffsetLeft + 'px,' + groups[i].data.offsetTop + 'px, 0)' + cssPriority + '']]);
        }
    },
