...
<div style="margin: 306px auto 0 auto;background-color: white;text-align: center;padding:60px 60px 50px 60px;width: 600px;">
    ...
    <h1 style="font-family:'Open Sans', Helvetica, Arial, sans-serif;font-size: 22px;color:#333333;margin-bottom: 30px">
		<?php _e( 'Unsubscribed', 'wpdef' ) ?>
    </h1>
    <p style="font-family:'Open Sans', Helvetica, Arial, sans-serif;font-size: 13px;color:#666;line-height: 25px;margin-bottom: 30px">
		<?php printf( __( 'You are now unsubscribed from %s.', 'wpdef' ), $title ) ?>
    </p>
</div>
<p style="text-align: center;width: 100%;font-size: 13px;color:#888888;font-family:'Open Sans', Helvetica, Arial, sans-serif;margin-top: 20px">
	<?php printf( __( 'Made a mistake? <a style="font-weight: bold;text-decoration: none;color:#888888" href="%s">Resubscribe</a>', 'wpdef' ), $url ) ?>
</p>
</body>
</html>