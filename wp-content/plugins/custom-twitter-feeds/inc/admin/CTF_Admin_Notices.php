...
class CTF_Admin_Notices
{
	...
	public function init() {
        ...
        add_action( 'wp_ajax_ctf_dismiss_upgrade_notice', array( $this, 'dismiss_upgrade_notice' ) );
	}
    ...
    public function dismiss_upgrade_notice() {
        ...
        check_ajax_referer( 'ctf_nonce' , 'ctf_nonce');
    ...
    public function get_renew_url() {
        ...
        $url = sprintf(
            'https://smashballoon.com/checkout/?edd_license_key=%s&download_id=%s&utm_campaign=twitter-free&utm_source=expired-notice&utm_medium=renew-license',
            $license_key,
	        CTF_PRODUCT_ID
        );
