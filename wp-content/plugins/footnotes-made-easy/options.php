...
?>
	<?php if ( '' !== $message ) { ?>
	<div class="updated"><p><strong><?php echo ( $message ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></strong></p></div>
	<?php } ?>
	...
	<form method="post">
		...
		<table class="form-table">
			...
			<tr>
			<th scope="row"><label for="pre_identifier"><?php esc_html_e( ucwords( 'identifier' ), 'footnotes-made-easy' ); ?></label></th>
			<td>
			...
			<select name="list_style_type">
				...
				<option value="<?php echo \esc_attr( $key ); ?>" 
					<?php
					if ( $this->current_options['list_style_type'] === $key ) {
			...
			<tr>
			<th scope="row"><label for="list_style_symbol"><?php esc_html_e( ucwords( 'symbol' ), 'footnotes-made-easy' ); ?></label></th>
			...
			<tr>
			<th scope="row"><label for="superscript"><?php esc_html_e( ucwords( 'superscript' ), 'footnotes-made-easy' ); ?></label></th>
			...
			<tr>
			<th scope="row"><label for="pre_backlink"><?php esc_html_e( ucwords( 'back-link' ), 'footnotes-made-easy' ); ?></label></th>
			<td>
			...
			<p class="description"><?php esc_html_e( sprintf( 'These affect how the back-links after each footnote look. A good back-link character is %s. If you want to remove the back-links all together, you can effectively do so by making all these settings blank.', '&amp;#8617; (↩)' ), 'footnotes-made-easy' ); ?></p></td>
			</tr>

			<tr>
			<th scope="row"><label for="pre_footnotes"><?php esc_html_e( ucwords( 'Footnotes header' ), 'footnotes-made-easy' ); ?></label></th>
			...
			<tr>
			<th scope="row"><label for="post_footnotes"><?php esc_html_e( ucwords( 'Footnotes footer' ), 'footnotes-made-easy' ); ?></label></th>
			...
			<tr>
			<th scope="row"><?php esc_html_e( ucwords( 'pretty tooltips' ), 'footnotes-made-easy' ); ?></th>
			...
			<tr>
			<th scope="row"><?php esc_html_e( ucwords( 'combine notes' ), 'footnotes-made-easy' ); ?></th>
			...
			<tr>
			<th scope="row"><label for="priority"><?php esc_html_e( ucwords( 'priority' ), 'footnotes-made-easy' ); ?></label></th>
			...
			<tr>
			<th scope="row"><?php esc_html_e( ucwords( 'suppress Footnotes' ), 'footnotes-made-easy' ); ?></th>
			<td>
			<label for="no_display_home"><input type="checkbox" name="no_display_home" id="no_display_home" <?php checked( $this->current_options['no_display_home'], true ); ?> />&nbsp;<?php esc_html_e( ucwords( 'on the home page' ), 'footnotes-made-easy' ); ?></label></br>
			<label for="no_display_preview"><input type="checkbox" name="no_display_preview" id="no_display_preview" <?php checked( $this->current_options['no_display_preview'], true ); ?> />&nbsp;<?php esc_html_e( ucwords( 'when displaying a preview' ), 'footnotes-made-easy' ); ?></label></br>
			<label for="no_display_search"><input type="checkbox" name="no_display_search" id="no_display_search" <?php checked( $this->current_options['no_display_search'], true ); ?> />&nbsp;<?php esc_html_e( ucwords( 'in search results' ), 'footnotes-made-easy' ); ?></label></br>
			...
			<label for="no_display_archive"><input type="checkbox" name="no_display_archive" id="no_display_archive" <?php checked( $this->current_options['no_display_archive'], true ); ?> />&nbsp;<?php esc_html_e( ucwords( 'in any kind of archive' ), 'footnotes-made-easy' ); ?></label></br>
			<label for="no_display_category"><input type="checkbox" name="no_display_category" id="no_display_category" <?php checked( $this->current_options['no_display_category'], true ); ?> />&nbsp;<?php esc_html_e( ucwords( 'in category archives' ), 'footnotes-made-easy' ); ?></label></br>
		...
		<table class="form-table">
			...
			<tr>
			<th scope="row"><label for="footnotes_open"><?php esc_html_e( ucwords( 'begin a footnote' ), 'footnotes-made-easy' ); ?></label></th>
			...
			<tr>
			<th scope="row"><label for="footnotes_close"><?php esc_html_e( ucwords( 'end a Footnote' ), 'footnotes-made-easy' ); ?></label></th>
		...
		<p class="submit"><input type="submit" name="save_options" value="<?php esc_html_e( ucwords( 'save changes' ), 'footnotes-made-easy' ); ?>" class="button-primary" /></p>
