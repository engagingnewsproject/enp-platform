 ...
 */
namespace NF_FU_VENDOR\Composer;

use NF_FU_VENDOR\Composer\Autoload\ClassLoader;
use NF_FU_VENDOR\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('NF_FU_VENDOR\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
