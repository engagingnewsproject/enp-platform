...
namespace NF_FU_VENDOR\Aws\Multipart;

use NF_FU_VENDOR\Aws\AwsClientInterface as Client;
use NF_FU_VENDOR\Aws\CommandInterface;
use NF_FU_VENDOR\Aws\CommandPool;
...
abstract class AbstractUploadManager implements Promise\PromisorInterface
{
    ...
    private static $defaultConfig = ['part_size' => null, 'state' => null, 'concurrency' => self::DEFAULT_CONCURRENCY, 'prepare_data_source' => null, 'before_initiate' => null, 'before_upload' => null, 'before_complete' => null, 'exception_class' => 'NF_FU_VENDOR\\Aws\\Exception\\MultipartUploadException'];
