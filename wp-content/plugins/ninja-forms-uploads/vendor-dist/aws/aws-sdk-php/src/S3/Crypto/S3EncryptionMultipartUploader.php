...
use NF_FU_VENDOR\Aws\Crypto\AbstractCryptoClient;
use NF_FU_VENDOR\Aws\Crypto\EncryptionTrait;
use NF_FU_VENDOR\Aws\Crypto\MetadataEnvelope;
use NF_FU_VENDOR\Aws\Crypto\Cipher\CipherBuilderTrait;
use NF_FU_VENDOR\Aws\S3\MultipartUploader;
use NF_FU_VENDOR\Aws\S3\S3ClientInterface;
