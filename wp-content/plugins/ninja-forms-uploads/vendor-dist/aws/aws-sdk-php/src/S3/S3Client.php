...
use NF_FU_VENDOR\Aws\S3\UseArnRegion\Configuration;
use NF_FU_VENDOR\Aws\S3\UseArnRegion\ConfigurationInterface;
use NF_FU_VENDOR\Aws\S3\UseArnRegion\ConfigurationProvider as UseArnRegionConfigurationProvider;
