 ...
 */
use NF_FU_VENDOR\google\appengine\api\app_identity\AppIdentityService;
...
class AppIdentityCredentials extends CredentialsLoader implements SignBlobInterface
{
    ...
    {
        if (!self::onAppEngine() || !\class_exists('NF_FU_VENDOR\\google\\appengine\\api\\app_identity\\AppIdentityService')) {
