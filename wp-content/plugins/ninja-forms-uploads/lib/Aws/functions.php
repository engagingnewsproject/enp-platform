...
function default_http_handler()
{
    ...
    if ($version === 6 || $version === 7) {
        return new \NF_FU_LIB\Aws\Handler\GuzzleV6\GuzzleHandler();
    }
    // If Guzzle 5 installed
    if ($version === 5) {
        return new \NF_FU_LIB\Aws\Handler\GuzzleV5\GuzzleHandler();
    }
...
function guzzle_major_version()
{
    ...
    if (\defined('\\NF_FU_LIB\\GuzzleHttp\\ClientInterface::VERSION')) {
