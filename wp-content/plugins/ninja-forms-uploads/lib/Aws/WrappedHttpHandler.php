...
class WrappedHttpHandler
{
     ...
     *                                 information.
     */
    public function __construct(callable $httpHandler, callable $parser, callable $errorParser, $exceptionClass = 'NF_FU_LIB\\Aws\\Exception\\AwsException', $collectStats = \false)
    {
    ...
    public function __invoke(CommandInterface $command, RequestInterface $request)
    {
        ...
        return Create::promiseFor($fn($request, $options))->then(function (ResponseInterface $res) use($command, $request, &$stats) {
