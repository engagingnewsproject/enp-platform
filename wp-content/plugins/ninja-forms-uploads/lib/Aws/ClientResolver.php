...
use NF_FU_LIB\Aws\Api\Validator;
use NF_FU_LIB\Aws\Api\ApiProvider;
use NF_FU_LIB\Aws\Api\Service;
use NF_FU_LIB\Aws\ClientSideMonitoring\ApiCallAttemptMonitoringMiddleware;
use NF_FU_LIB\Aws\ClientSideMonitoring\ApiCallMonitoringMiddleware;
use NF_FU_LIB\Aws\ClientSideMonitoring\Configuration;
use NF_FU_LIB\Aws\Credentials\Credentials;
use NF_FU_LIB\Aws\Credentials\CredentialsInterface;
use NF_FU_LIB\Aws\Endpoint\PartitionEndpointProvider;
use NF_FU_LIB\Aws\EndpointDiscovery\ConfigurationInterface;
use NF_FU_LIB\Aws\EndpointDiscovery\ConfigurationProvider;
use NF_FU_LIB\Aws\EndpointDiscovery\EndpointDiscoveryMiddleware;
use NF_FU_LIB\Aws\Signature\SignatureProvider;
use NF_FU_LIB\Aws\Endpoint\EndpointProvider;
use NF_FU_LIB\Aws\Credentials\CredentialProvider;
...
class ClientResolver
{
    ...
    {
        if ($value === \false) {
            $value = new Configuration(\false, \NF_FU_LIB\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_HOST, \NF_FU_LIB\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_PORT, \NF_FU_LIB\Aws\ClientSideMonitoring\ConfigurationProvider::DEFAULT_CLIENT_ID);
            $args['csm'] = $value;
        }
    ...
    {
        if ($value !== \false) {
            $list->interpose(new TraceMiddleware($value === \true ? [] : $value));
        }
    }
