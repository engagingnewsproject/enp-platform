...
use NF_FU_LIB\Aws\Api\Serializer\QuerySerializer;
use NF_FU_LIB\Aws\Api\Serializer\Ec2ParamBuilder;
use NF_FU_LIB\Aws\Api\Parser\QueryParser;
/**
...
class Service extends AbstractModel
{
    ...
    {
        static $mapping = ['json' => 'NF_FU_LIB\\Aws\\Api\\Serializer\\JsonRpcSerializer', 'query' => 'NF_FU_LIB\\Aws\\Api\\Serializer\\QuerySerializer', 'rest-json' => 'NF_FU_LIB\\Aws\\Api\\Serializer\\RestJsonSerializer', 'rest-xml' => 'NF_FU_LIB\\Aws\\Api\\Serializer\\RestXmlSerializer'];
    ...
    {
        static $mapping = ['json' => 'NF_FU_LIB\\Aws\\Api\\ErrorParser\\JsonRpcErrorParser', 'query' => 'NF_FU_LIB\\Aws\\Api\\ErrorParser\\XmlErrorParser', 'rest-json' => 'NF_FU_LIB\\Aws\\Api\\ErrorParser\\RestJsonErrorParser', 'rest-xml' => 'NF_FU_LIB\\Aws\\Api\\ErrorParser\\XmlErrorParser', 'ec2' => 'NF_FU_LIB\\Aws\\Api\\ErrorParser\\XmlErrorParser'];
    ...
    {
        static $mapping = ['json' => 'NF_FU_LIB\\Aws\\Api\\Parser\\JsonRpcParser', 'query' => 'NF_FU_LIB\\Aws\\Api\\Parser\\QueryParser', 'rest-json' => 'NF_FU_LIB\\Aws\\Api\\Parser\\RestJsonParser', 'rest-xml' => 'NF_FU_LIB\\Aws\\Api\\Parser\\RestXmlParser'];
        $proto = $api->getProtocol();
        if (isset($mapping[$proto])) {
