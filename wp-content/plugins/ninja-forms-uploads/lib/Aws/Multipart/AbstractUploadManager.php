...
namespace NF_FU_LIB\Aws\Multipart;

use NF_FU_LIB\Aws\AwsClientInterface as Client;
use NF_FU_LIB\Aws\CommandInterface;
use NF_FU_LIB\Aws\CommandPool;
use NF_FU_LIB\Aws\Exception\AwsException;
use NF_FU_LIB\Aws\Exception\MultipartUploadException;
use NF_FU_LIB\Aws\Result;
use NF_FU_LIB\Aws\ResultInterface;
use NF_FU_LIB\GuzzleHttp\Promise;
use NF_FU_LIB\GuzzleHttp\Promise\Coroutine;
...
abstract class AbstractUploadManager implements Promise\PromisorInterface
{
    ...
    private static $defaultConfig = ['part_size' => null, 'state' => null, 'concurrency' => self::DEFAULT_CONCURRENCY, 'prepare_data_source' => null, 'before_initiate' => null, 'before_upload' => null, 'before_complete' => null, 'exception_class' => 'NF_FU_LIB\\Aws\\Exception\\MultipartUploadException'];
