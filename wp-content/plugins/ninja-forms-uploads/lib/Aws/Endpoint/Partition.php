...
namespace NF_FU_LIB\Aws\Endpoint;

use ArrayAccess;
use NF_FU_LIB\Aws\HasDataTrait;
use NF_FU_LIB\Aws\Sts\RegionalEndpoints\ConfigurationProvider;
use NF_FU_LIB\Aws\S3\RegionalEndpoint\ConfigurationProvider as S3ConfigurationProvider;
