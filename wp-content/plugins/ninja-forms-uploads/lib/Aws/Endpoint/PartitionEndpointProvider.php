...
class PartitionEndpointProvider
{
    ...
    {
        $data = \NF_FU_LIB\Aws\load_compiled_json(__DIR__ . '/../data/endpoints.json');
        $prefixData = \NF_FU_LIB\Aws\load_compiled_json(__DIR__ . '/../data/endpoints_prefix_history.json');
