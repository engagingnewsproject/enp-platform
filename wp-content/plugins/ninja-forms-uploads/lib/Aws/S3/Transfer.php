...
use NF_FU_LIB\GuzzleHttp\Promise\Each;
use NF_FU_LIB\GuzzleHttp\Promise\PromisorInterface;
use Iterator;

use function NF_FU_LIB\GuzzleHttp\Promise\each;
...
class Transfer implements PromisorInterface
{
    ...
    private function createUploadPromise()
    {
        ...
        $files = \NF_FU_LIB\Aws\map($this->getUploadsIterator(), function ($file) {
        ...
        return Each::ofLimitAll($files, $this->concurrency);
    }
    /** @return Iterator */
