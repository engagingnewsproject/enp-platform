...
use NF_FU_LIB\Aws\MultiRegionClient as BaseClient;
use NF_FU_LIB\Aws\Exception\AwsException;
use NF_FU_LIB\Aws\S3\Exception\PermanentRedirectException;
    ...
    private function determineRegionMiddleware()
    {
        return function (callable $handler) {
            return function (CommandInterface $command) use($handler) {
                ...
                return Coroutine::of(function () use($handler, $command, $cacheKey) {
                    try {
