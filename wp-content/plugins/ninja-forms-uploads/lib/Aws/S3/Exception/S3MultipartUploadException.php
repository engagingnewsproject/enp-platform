...
namespace NF_FU_LIB\Aws\S3\Exception;

use NF_FU_LIB\Aws\CommandInterface;
use NF_FU_LIB\Aws\Exception\AwsException;
use NF_FU_LIB\Aws\Multipart\UploadState;
class S3MultipartUploadException extends \NF_FU_LIB\Aws\Exception\MultipartUploadException
{
