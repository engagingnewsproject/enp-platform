...
namespace NF_FU_LIB\Monolog\Handler;

use NF_FU_LIB\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use NF_FU_LIB\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
use NF_FU_LIB\Monolog\Logger;
use NF_FU_LIB\Monolog\ResettableInterface;
use NF_FU_LIB\Monolog\Formatter\FormatterInterface;
use NF_FU_LIB\Psr\Log\LogLevel;
