...
namespace NF_FU_LIB\GuzzleHttp\Handler;
...
use NF_FU_LIB\GuzzleHttp\Promise\FulfilledPromise;
use NF_FU_LIB\GuzzleHttp\Promise\PromiseInterface;
use NF_FU_LIB\GuzzleHttp\Psr7\LazyOpenStream;
use NF_FU_LIB\GuzzleHttp\TransferStats;
use NF_FU_LIB\GuzzleHttp\Utils;
use NF_FU_LIB\GuzzleHttp\Psr7\Utils as Psr7Utils;
...
class CurlFactory implements CurlFactoryInterface
{
    ...
    private function applyHandlerOptions(EasyHandle $easy, array &$conf): void
    {
        ...
        if (!isset($options['sink'])) {
            ...
            $options['sink'] = Psr7Utils::tryFopen('php://temp', 'w+');
        }
        $sink = $options['sink'];
        if (!\is_string($sink)) {
