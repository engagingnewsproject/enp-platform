...
namespace NF_FU_LIB\Google\Auth\Credentials;

use NF_FU_LIB\Google\Auth\CredentialsLoader;
use NF_FU_LIB\Google\Auth\GetQuotaProjectInterface;
use NF_FU_LIB\Google\Auth\HttpHandler\HttpClientCache;
use NF_FU_LIB\Google\Auth\HttpHandler\HttpHandlerFactory;
use NF_FU_LIB\Google\Auth\Iam;
use NF_FU_LIB\Google\Auth\IamSignerTrait;
use NF_FU_LIB\Google\Auth\ProjectIdProviderInterface;
use NF_FU_LIB\Google\Auth\SignBlobInterface;
use NF_FU_LIB\GuzzleHttp\Exception\ClientException;
use NF_FU_LIB\GuzzleHttp\Exception\ConnectException;
use NF_FU_LIB\GuzzleHttp\Exception\RequestException;
use NF_FU_LIB\GuzzleHttp\Exception\ServerException;
 ...
 *
 *   use NF_FU_LIB\Google\Auth\Credentials\GCECredentials;
 *   use NF_FU_LIB\Google\Auth\Middleware\AuthTokenMiddleware;
 *   use NF_FU_LIB\GuzzleHttp\Client;
 *   use NF_FU_LIB\GuzzleHttp\HandlerStack;
 *
