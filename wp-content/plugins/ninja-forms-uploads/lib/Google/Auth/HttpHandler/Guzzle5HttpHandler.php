 ...
 */
namespace NF_FU_LIB\Google\Auth\HttpHandler;

use Exception;
use NF_FU_LIB\GuzzleHttp\ClientInterface;
use NF_FU_LIB\GuzzleHttp\Message\ResponseInterface as Guzzle5ResponseInterface;
use NF_FU_LIB\GuzzleHttp\Promise\Promise;
use NF_FU_LIB\GuzzleHttp\Promise\RejectedPromise;
