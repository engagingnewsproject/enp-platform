<?php
namespace NF_FU_LIB\Google\Client;
/*
...
use NF_FU_LIB\Google\Auth\ApplicationDefaultCredentials;
use NF_FU_LIB\Google\Auth\Cache\MemoryCacheItemPool;
use NF_FU_LIB\Google\Auth\CredentialsLoader;
use NF_FU_LIB\Google\Auth\HttpHandler\HttpHandlerFactory;
use NF_FU_LIB\Google\Auth\OAuth2;
use NF_FU_LIB\Google\Auth\Credentials\ServiceAccountCredentials;
use NF_FU_LIB\Google\Auth\Credentials\UserRefreshCredentials;
use NF_FU_LIB\Google\Client\Http\REST;
use NF_FU_LIB\Google\Client\AuthHandler\AuthHandlerFactory;
use NF_FU_LIB\Google\AccessToken\Revoke;
use NF_FU_LIB\Google\AccessToken\Verify;
use NF_FU_LIB\GuzzleHttp\Client as GuzzleClient;
...
use NF_FU_LIB\Psr\Log\LoggerInterface;
use NF_FU_LIB\Monolog\Logger;
use NF_FU_LIB\Monolog\Handler\StreamHandler as MonologStreamHandler;
use NF_FU_LIB\Monolog\Handler\SyslogHandler as MonologSyslogHandler;
...
class Client
{
  ...
  /**
   * @return \NF_FU_LIB\Psr\Cache\CacheItemPoolInterface Cache implementation
   */
