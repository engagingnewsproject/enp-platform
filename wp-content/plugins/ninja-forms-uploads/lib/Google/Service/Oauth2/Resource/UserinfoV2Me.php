...
namespace NF_FU_LIB\Google\Service\Oauth2\Resource;

use NF_FU_LIB\Google\Client\Service\Resource;
use NF_FU_LIB\Google\Service\Oauth2\Userinfo as UserinfoModel;
 ...
 *  </code>
 */
class UserinfoV2Me extends Resource
{
  /**
   * (me.get)
   *
