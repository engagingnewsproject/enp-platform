...
{ ?>
    <div class="updated notice">
        ...
        <p>The <a href="http://mediaengagement.org" target="_blank">Center for Media Engagement</a> created Engaging Buttons after we found that <a href="http://mediaengagement.org/research/social-media-buttons/" target="_blank">having a "Respect" button in comment sections could have business and democratic benefits</a>.</p>

        <p>Help us improve the Engaging Buttons plugin by allowing your click data to be sent to the Center for Media Engagement. You will also be helping us continue to provide free, high-quality research.</p>
...
{
    // redirect to settings page if this form is submitted
    wp_redirect(admin_url('options-general.php?page=enp_button_page'));
    exit;
}
?>