...
{ ?>
                            ...
                            <td>
                                <fieldset>
                                    ...
                                    <label for="enp_button_allow_data_tracking">
                                        ...
                                        <p id="enp-button-allow-data-tracking-description" class="description">This allows <a href="http://mediaengagement.org">The Center for Media Engagement</a>, an academic nonprofit at the University of Texas at Austin, to record data on the buttons so they can continue to provide free, open-source plugins and research. No personal information is recorded.</p>
                                    </label>
                                    <label for="enp_button_promote_enp">
                                        <input type="checkbox" id="enp_button_promote_enp" name="enp_button_promote_enp" aria-describedby="enp-button-promote-enp-description" <?php checked(true, $btn_promote_enp); ?> value="1" /> Display "Respect Button Powered by the Center for Media Engagement"
                                    ...
                                    <div class="enp-btns-wrap <?echo $enp_btn_icon_class;?>">
                                        <ul class="enp-btns">
                                            <li class="enp-btn-wrap">
                                                <a href="#" class="enp-btn enp-btn--user-has-not-clicked"><svg class="enp-icon">
                                                        <use xlink:href="#enp-btn--user-has-not-clicked"></use>
                                                    </svg><span class="enp-btn__name">Respect</span><span class="enp-btn__count">75</span></a>
                                            </li>
                                        </ul>
                                    </div>
                            </th>
                        ...
                        <tr id="advanced-css-row">
                            ...
                            <td>
                                ...
                                <div class="advanced-css">
                                    ...
                                    <textarea name="enp_button_color_css" class="wide-fat enp-css" id="enp-css" wrap="off" rows="15" readonly></textarea>
                            </td>
            </div>
            </tr>
    ...
    <p>The Respect Button plugin is made by the <a href="http://mediaengagement.org">Center for Media Engagement</a>, a nonprofit at the University of Texas at Austin that researches COMMERCIALLY-VIABLE and DEMOCRATICALLY-BENEFICIAL ways to improve ONLINE NEWS</p>
    </div>
<?php
}
