...
<section class="enp-results">
    ...
    <ul class="enp-results__share">
        <li class="enp-results__share__item"><a class="enp-results__share__link enp-results__share__item--facebook" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode($current_url->get_full_url());?>&amp;quote=<?php echo $qt_end->get_share_content('facebook_quote_end', 'url');?>">
        ...
        <li class="enp-results__share__item"><a class="enp-results__share__link enp-results__share__item--twitter" target="_blank" href="http://twitter.com/intent/tweet?text=<?php echo $qt_end->get_share_content('tweet_end', 'url');?>&url=<?php echo $current_url->get_full_url();?>">
        ...
        <li class="enp-results__share__item"><a class="enp-results__share__link enp-results__share__item--email" href="mailto:?subject=<?php echo $qt_end->get_share_content('email_subject', 'rawurl');?>&body=<?php echo $qt_end->get_share_content('email_body_end', 'rawurl').rawurlencode(' '.$current_url->get_full_url());?>">
