<div class="enp-container enp-ab-embed-code">
    ...
    <textarea class="enp-embed-code enp-embed-code__textarea" rows="8"><script type="text/javascript" src="<?php echo ENP_QUIZ_PLUGIN_URL;?>public/quiz-take/js/dist/iframe-parent.min.js"></script>
