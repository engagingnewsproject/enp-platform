...
echo 'https://engagingnewsproject.com/wp-content/plugins/enp-quiz/'?>public/quiz-take/js/dist/iframe-parent.min.js"></script>
<iframe id="enp-quiz-iframe-<?php echo $quiz->get_quiz_id();?>" class="enp-quiz-iframe" src="<?php // echo ENP_QUIZ_URL
'https://engagingnewsproject.org/quiz-embed/'.$quiz->get_quiz_id();?>" style="width: <? echo $quiz->get_quiz_width();?>; height: 500px; border: none"></iframe>
</textarea>
