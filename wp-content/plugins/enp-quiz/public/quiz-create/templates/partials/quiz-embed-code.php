...
<textarea id="enp-embed-code" class="enp-embed-code enp-publish-page__embed-code" rows="7" readonly><script type="text/javascript" src="<?php echo ENP_QUIZ_PLUGIN_URL;?>public/quiz-take/js/dist/iframe-parent.js"></script>
