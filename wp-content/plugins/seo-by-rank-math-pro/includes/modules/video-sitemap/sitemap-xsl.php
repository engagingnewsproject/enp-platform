				...
				<tbody>
					<xsl:for-each select="sitemap:urlset/sitemap:url">
						<tr>
							...
							<td>
								<xsl:value-of select="concat(substring(video:video/video:publication_date,0,11),concat(' ', substring(video:video/video:publication_date,12,5)),concat(' ', substring(video:video/video:publication_date,20,6)))"/>
							</td>
						</tr>
					</xsl:for-each>
				</tbody>
