...
return apply_filters( 'ninja_forms_available_actions', array(
    ...
    'mailchimp'             => array(
        ...
        'name'              => 'mailchimp',
        'nicename'          => 'MailChimp',
        'link'              => 'https://ninjaforms.com/extensions/mail-chimp/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=MailChimp+Ghost+Action',
        ...
        'modal_content'     => '<div class="available-action-modal">
                                    ...
                                    <div class="actions">
                                        <a target="_blank" href="https://ninjaforms.com/extensions/mail-chimp/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=MailChimp+Ghost+Action" title="MailChimp" class="primary nf-button">Learn More</a>
                                    </div>
                                </div>',
    ),
    ...
    'zapier'                => array(
        ...
        'modal_content'     => '<div class="available-action-modal">
                                ...
                                <div class="actions">
                                    <a target="_blank" href="https://ninjaforms.com/extensions/zapier/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=Zapier+Ghost+Action" title="Zapier" class="primary nf-button">Learn More</a>
                                </div>
                            </div>',
    ),
    ...
    'file_uploads'          => array(
        ...
        'link'              => 'https://ninjaforms.com/extensions/file-uploads/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=File+Uploads+Ghost+Action',
        ...
        'modal_content'     => '<div class="available-action-modal">
                                ...
                                <div class="actions">
                                    <a target="_blank" href="https://ninjaforms.com/extensions/file-uploads/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=File+Uploads+Ghost+Action" title="File Uploads" class="primary nf-button">Learn More</a>
                                </div>
                            </div>',
    ),
    ...
    'createposts'           => array(
        ...
        'modal_content'     => '<div class="available-action-modal">
                                ...
                                <div class="actions">
                                    <a target="_blank" href="https://ninjaforms.com/extensions/front-end-posting/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=Front-End+Posting+Ghost+Action" title="Front-End Posting" class="primary nf-button">Learn More</a>
                                </div>
                            </div>',
    ),
    ...
    'trello'                => array(
        ...
        'modal_content'     => '<div class="available-action-modal">
                                ...
                                <div class="actions">
                                    <a target="_blank" href="https://ninjaforms.com/extensions/trello/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=Trello+Ghost+Action" title="Trello" class="primary nf-button">Learn More</a>
                                </div>
                            </div>',
    ),
    ...
    'slack'                 => array(
        ...
        'modal_content'     => '<div class="available-action-modal">
                                    ...
                                    <div class="actions">
                                        <a target="_blank" href="https://ninjaforms.com/extensions/slack/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=Slack+Ghost+Action" title="Slack" class="primary nf-button">Learn More</a>
                                    </div>
                                </div>',
    ),
    ...
    'webhooks'              => array(
        ...
        'modal_content'     => '<div class="available-action-modal">
                                ...
                                <div class="actions">
                                    <a target="_blank" href="https://ninjaforms.com/extensions/webhooks/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=WebHooks+Ghost+Action" title="WebHooks" class="primary nf-button">Learn More</a>
                                </div>
                            </div>',
    ),
    ...
    'campaignmonitor'       => array(
        ...
        'modal_content'     => '<div class="available-action-modal">
                                    ...
                                    <div class="actions">
                                        <a target="_blank" href="https://ninjaforms.com/extensions/campaign-monitor/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=Campaign+Monitor+Ghost+Action" title="Campaign Monitor" class="primary nf-button">Learn More</a>
                                    </div>
                                </div>',
    ),
    ...
    'constantcontact'       => array(
        ...
        'modal_content'     => '<div class="available-action-modal">
                                    ...
                                    <div class="actions">
                                        <a target="_blank" href="https://ninjaforms.com/extensions/constant-contact/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=Constant+Contact+Ghost+Action" title="Constant Contact" class="primary nf-button">Learn More</a>
                                    </div>
                                </div>',
    ),
    ...
    'aweber'                => array(
        ...
        'modal_content'     => '<div class="available-action-modal">
                                    ...
                                    <div class="actions">
                                        <a target="_blank" href="https://ninjaforms.com/extensions/aweber/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=AWeber+Ghost+Action" title="AWeber" class="primary nf-button">Learn More</a>
                                    </div>
                                </div>',
    ),
    ...
    'emma'                  => array(
        ...
        'modal_content'     => '<div class="available-action-modal">
                                ...
                                <div class="actions">
                                    <a target="_blank" href="https://ninjaforms.com/extensions/emma/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=Emma+Ghost+Action" title="Emma" class="primary nf-button">Learn More</a>
                                </div>
                            </div>',
    ),
    ...
    'webmerge'              => array(
        ...
        'name'              => 'webmerge',
        'nicename'          => 'WebMerge',
        'link'              => 'https://ninjaforms.com/extensions/webmerge/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=WebMerge+Ghost+Action',
        ...
        'modal_content'     => '<div class="available-action-modal">
                                ...
                                <div class="actions">
                                    <a target="_blank" href="https://ninjaforms.com/extensions/webmerge/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=WebMerge+Ghost+Action" title="WebMerge" class="primary nf-button">Learn More</a>
                                </div>
                            </div>',
    ),
    ...
    'twilio_sms'            => array(
        ...
        'modal_content'     => '<div class="available-action-modal">
                                ...
                                <div class="actions">
                                    <a target="_blank" href="https://ninjaforms.com/extensions/twilio-sms/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=Twilio+SMS+Ghost+Action" title="Twilio SMS" class="primary nf-button">Learn More</a>
                                </div>
                            </div>',
    ),
    ...
    'clicksend_sms'            => array(
        ...
        'modal_content'     => '<div class="available-action-modal">
                                ...
                                <p>Get instant SMS notifications with every new WordPress form submission. Respond to leads faster and make more personal connections!</p>
                                <div class="actions">
                                    <a target="_blank" href="https://ninjaforms.com/extensions/clicksend-sms/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=ClickSend+SMS+Ghost+Action" title="ClickSend SMS" class="primary nf-button">Learn More</a>
                                </div>
                            </div>',
    ),
    ...
    'email_octopus'         => array(
        ...
        'modal_content'     => '<div class="available-action-modal">
                                ...
                                <div class="actions">
                                    <a target="_blank" href="https://ninjaforms.com/extensions/emailoctopus/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=EmailOctopus+Ghost+Action" title="EmailOctopus" class="primary nf-button">Learn More</a>
                                </div>
                            </div>',
    ),
    ...
    'stripe'                => array(
        ...
        'modal_content'     => '<div class="available-action-modal">
                                ...
                                <div class="actions">
                                    <a target="_blank" href="https://ninjaforms.com/extensions/stripe/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=Stripe+Ghost+Action" title="Stripe" class="primary nf-button">Learn More</a>
                                </div>
                            </div>',
    ),
    ...
    'paypal'                => array(
        ...
        'link'              => 'https://ninjaforms.com/extensions/paypal-express/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=PayPal+Express+Ghost+Action',
        ...
        'modal_content'     => '<div class="available-action-modal">
                                ...
                                <div class="actions">
                                    <a target="_blank" href="https://ninjaforms.com/extensions/paypal-express/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=PayPal+Express+Ghost+Action" title="PayPal Express" class="primary nf-button">Learn More</a>
                                </div>
                            </div>',
    ),
    ...
    'elavon'                => array(
        ...
        'modal_content'     => '<div class="available-action-modal">
                                ...
                                <div class="actions">
                                    <a target="_blank" href="https://ninjaforms.com/extensions/elavon/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=Elavon+Ghost+Action" title="Elavon" class="primary nf-button">Learn More</a>
                                </div>
                            </div>',
    ),
    ...
    'pipelinedeals-crm'      => array(
        ...
        'link'              => 'https://ninjaforms.com/extensions/pipelinedeals-crm/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=PipelineDeals+Ghost+Action',
        ...
        'modal_content'     => '<div class="available-action-modal">
                                ...
                                <div class="actions">
                                    <a target="_blank" href="https://ninjaforms.com/extensions/pipelinedeals-crm/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=PipelineDeals+Ghost+Action" title="PipelineDeals CRM" class="primary nf-button">Learn More</a>
                                </div>
                            </div>',
    ),
    ...
    'active-campaign'       => array(
        ...
        'modal_content'     => '<div class="available-action-modal">
                                ...
                                <div class="actions">
                                    <a target="_blank" href="https://ninjaforms.com/extensions/active-campaign/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=Active+Campaign+Ghost+Action" title="Active Campaign" class="primary nf-button">Learn More</a>
                                </div>
                            </div>',
    ),
    ...
    'insightly-crm'         => array(
        ...
        'modal_content'     => '<div class="available-action-modal">
                                ...
                                <div class="actions">
                                    <a target="_blank" href="https://ninjaforms.com/extensions/insightly-crm/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=Insightly+Ghost+Action" title="Insightly CRM" class="primary nf-button">Learn More</a>
                                </div>
                            </div>',
    ),
    ...
    'register-user'       => array(
        ...
        'modal_content'     => '<div class="available-action-modal">
                                ...
                                <div class="actions">
                                    <a target="_blank" href="https://ninjaforms.com/extensions/user-management/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=User+Management+Ghost+Action" title="User Management" class="primary nf-button">Learn More</a>
                                </div>
                            </div>',
    ),
    ...
    'helpscout'       => array(
        ...
        'modal_content'     => '<div class="available-action-modal">
                                ...
                                <div class="actions">
                                    <a target="_blank" href="https://ninjaforms.com/extensions/help-scout/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=Help+Scout+Ghost+Action" title="Help Scout" class="primary nf-button">Learn More</a>
                                </div>
                            </div>',
    ),
    ...
    'salesforce-crm'        => array(
        ...
        'modal_content'     => '<div class="available-action-modal">
                                ...
                                <div class="actions">
                                    <a target="_blank" href="https://ninjaforms.com/extensions/salesforce-crm/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=Salesforce+Ghost+Action" title="Salesforce CRM" class="primary nf-button">Learn More</a>
                                </div>
                              </div>',
    ),
    ...
    'capsule-crm'           => array(
        ...
        'modal_content'     => '<div class="available-action-modal">
                                ...
                                <div class="actions">
                                    <a target="_blank" href="https://ninjaforms.com/extensions/capsule-crm/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=Capsule+Ghost+Action" title="Capsule CRM" class="primary nf-button">Learn More</a>
                                </div>
                            </div>',
    ),
    ...
    'recurly'               => array(
        ...
        'modal_content'     => '<div class="available-action-modal">
                                ...
                                <div class="actions">
                                    <a target="_blank" href="https://ninjaforms.com/extensions/recurly/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=Recurly+Ghost+Action" title="Recurly" class="primary nf-button">Learn More</a>
                                </div>
                            </div>',
    ),
    ...
    'highrise-crm'          => array(
        ...
        'link'              => 'https://ninjaforms.com/extensions/highrise-crm/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=Highrise+Ghost+Action',
        ...
        'modal_content'     => '<div class="available-action-modal">
                                ...
                                <p></p>
                                <div class="actions">
                                    <a target="_blank" href="https://ninjaforms.com/extensions/highrise-crm/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=Highrise+Ghost+Action" title="Highrise CRM" class="primary nf-button">Learn More</a>
                                </div>
                            </div>',
    ),
    ...
    'onepage-crm'           => array(
        ...
        'modal_content'     => '<div class="available-action-modal">
                                ...
                                <div class="actions">
                                    <a target="_blank" href="https://ninjaforms.com/extensions/onepage-crm/?utm_source=Ninja+Forms+Plugin&utm_medium=Form+Builder&utm_campaign=Ghost+Action&utm_content=OnePage+Ghost+Action" title="OnePage CRM" class="primary nf-button">Learn More</a>
                                </div>
                            </div>',
    ),
) );
