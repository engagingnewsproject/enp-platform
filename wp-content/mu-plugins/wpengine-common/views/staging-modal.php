...
<div id="stagingModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<div class="modal-body">
		<p style="font-size:1.2em;">Copying to staging will overwrite any changes made recently to your staging site. Are you sure you want to do this?
You can backup or restore your staging area in the <a href="<?php echo esc_url( sprintf( 'https://my.wpengine.com/installs/%s/backup_points?environment=staging', PWP_NAME ) ); ?>" target="_blank">User Portal</a>
		</p>
	</div>
